...
public class Order<K, T> implements Serializable{
    ...
    private com.baeldung.ls.events.model.Order.PaymentMethod paymentMethod;
    private K key;
    private T data;
    ...
    public Order(com.baeldung.ls.events.model.Order.PaymentMethod paymentMethod, K key, T data) {
    ...
    public com.baeldung.ls.events.model.Order.PaymentMethod getPaymentMethod() {
